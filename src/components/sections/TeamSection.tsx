...
const allTeamMembers = [
  ...
  { name: 'Aayush Sadaye', position: 'Lead Coordinator', image: leads_image_2, linkedin: '' },
  //Tech
  { name: 'Atharva Patankar', position: 'Tech Lead', image: tech_image_1, linkedin: 'https://www.linkedin.com/in/atharvapatankar?' },
  { name: 'Prem Gupta', position: 'Tech Core', image: tech_image_2, linkedin: 'https://www.linkedin.com/in/prem-gupta-616489335' },
  { name: 'Viraj Ravani', position: 'Tech Core', image: tech_image_3, linkedin: 'https://www.linkedin.com/in/virajravani'},
  { name: 'Yash Musterya', position: 'Tech Core', image: tech_image_4, linkedin: 'https://www.linkedin.com/in/yashmusterya/'},
  // PR
  { name: 'Safwaan Mahida', position: 'PR Lead', image: pr_image_1, linkedin: 'https://linkedin.com/in/example' },
  { name: 'Atharva Sawant', position: 'PR Core', image: pr_image_2, linkedin: 'https://linkedin.com/in/example' },
  ...
  { name: 'Princy Karani', position: 'PR Core', image: pr_image_5, linkedin: 'https://linkedin.com/in/example' },
  ...
  { name: 'Mahek Agnihotri', position: 'PR Core', image: pr_image_7, linkedin: 'https://linkedin.com/in/example' },
  // Media
  { name: 'Siddhi Jain', position: 'Media Lead', image: media_image_1, linkedin: 'https://linkedin.com/in/example' },
  { name: 'Saloni Sawant', position: 'Media Core', image: media_image_2, linkedin: 'https://linkedin.com/in/example' },
  ...
  { name: 'Khushi Paandey', position: 'Media Core', image: media_image_4, linkedin: 'https://linkedin.com/in/example' },
  ...
  { name: 'Manav Shirali', position: 'Media Core', image: media_image_6, linkedin: 'https://linkedin.com/in/example' },
  // Logistics
  { name: 'Tejal Kinjawade', position: 'Logistics Lead', image: logistics_image_1, linkedin: 'https://linkedin.com/in/example' },
  { name: 'Gargee Yellurkar', position: 'Logistics Core', image: logistics_image_2, linkedin: 'https://linkedin.com/in/example' },
  { name: 'Soham Narayankar', position: 'Logistics Core', image: logistics_image_3, linkedin: 'https://linkedin.com/in/example' },
  ...
  { name: 'Garv Gandhi', position: 'Logistics Core', image: logistics_image_5, linkedin: 'https://linkedin.com/in/example' },
  ...
  // Sponsors
  { name: 'Suhana', position: 'Sponsorship Lead', image: sponsors_image_1, linkedin: 'https://linkedin.com/in/example' },
  { name: 'Ayushi Kabra', position: 'Sponsorship Core', image: sponsors_image_2, linkedin: 'https://linkedin.com/in/example' },
